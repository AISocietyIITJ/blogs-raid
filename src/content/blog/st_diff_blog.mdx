...
description: "A complete guide to Stable Diffusion and how it uses latent space, U-Net, and CLIP to generate stunning images from noise"
pubDate: "2025-07-15"
heroImage: "/blogs-raid/st_diff_blog/hero_st_diff.png" 
tags: ["diffusion", "stable-diffusion", "generative-models", "deep-learning", "unet"]
authors:
  - name: "Sonam Sikarwar"
    url: "https://www.linkedin.com/in/sonam-sikarwar-7965a82b4/" 
  - name: "Arpita Deshmukh"
    url: "https://www.linkedin.com/in/arpita-deshmukh-9ba60428a/" 
...
<a href="https://diffusionflow.github.io/" target="_blank">Learn more</a>
...
If you are curious you can read more about CLIP in this <a href="https://viso.ai/deep-learning/clip-machine-learning/" target="_blank">article</a>.
...
$$
\mu_t = \sqrt{\alpha_t \alpha_{t-1}} \, x_{t-2} = \dots = \sqrt{\bar{\alpha}_t} \, x_0
$$
